...
public partial class GestaoPatrimoniosContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AreaID).HasName("PK__Area__70B820281D5A655B");

            entity.HasIndex(e => e.NomeArea, "UQ__Area__9A7797605777329C").IsUnique();
        ...
        {
            entity.HasKey(e => e.BairroID).HasName("PK__Bairro__4A09362328A79860");
        ...
        {
            entity.HasKey(e => e.CargoID).HasName("PK__Cargo__B4E665EDECFDD421");

            entity.HasIndex(e => e.NomeCargo, "UQ__Cargo__4D9FD7DE030FC0FF").IsUnique();
        ...
        {
            entity.HasKey(e => e.CidadeID).HasName("PK__Cidade__B68009598D3AA3D7");
        ...
        {
            entity.HasKey(e => e.EnderecoID).HasName("PK__Endereco__B9D9462F41D5DA7B");
        ...
        {
            entity.HasKey(e => e.LocalizacaoID).HasName("PK__Localiza__83ABDECAD43F9014");
        ...
        {
            entity.HasKey(e => e.LogPatrimonioID).HasName("PK__LogPatri__E716D12B9EF17E94");
        ...
        {
            entity.HasKey(e => e.PatrimonioID).HasName("PK__Patrimon__C5A60BDE762DE9B8");

            entity.ToTable(tb => tb.HasTrigger("trg_Patrimonio_SoftDelete"));

            entity.HasIndex(e => e.NumeroPatrimonio, "UQ__Patrimon__3BC8B35DAC4AEE45").IsUnique();
        ...
        {
            entity.HasKey(e => e.TransferenciaID).HasName("PK__Solicita__E5B4F5F2AE7FA902");
        ...
        {
            entity.HasKey(e => e.StatusPatrimonioID).HasName("PK__StatusPa__B3F336097D0956FD");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusPa__C5C60F1A215BF24A").IsUnique();
        ...
        {
            entity.HasKey(e => e.StatusTransferenciaID).HasName("PK__StatusTr__7AA828B959921313");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusTr__C5C60F1A1546F831").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoAlteracaoID).HasName("PK__TipoAlte__9BEF4F0DF5FFCB57");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoAlte__7859A10AE6A97AA9").IsUnique();
        ...
        modelBuilder.Entity<TipoUsuario>(entity =>
        {
            ...
            entity.HasIndex(e => e.NomeTipo, "UQ__TipoUsua__7859A10AEF518B7A").IsUnique();
        ...
        {
            entity.HasKey(e => e.UsuarioID).HasName("PK__Usuario__2B3DE798BCD331D3");

            entity.ToTable(tb => tb.HasTrigger("trg_Usuario_SoftDelete"));

            entity.HasIndex(e => e.RG, "UQ__Usuario__321537C8D7B52C5F").IsUnique();

            entity.HasIndex(e => e.CarteiraTrabalho, "UQ__Usuario__6E25BCA2F870FC28").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D105345E0B52C0").IsUnique();

            entity.HasIndex(e => e.CPF, "UQ__Usuario__C1F89731E9D0A02E").IsUnique();

            entity.HasIndex(e => e.NIF, "UQ__Usuario__C7DEC3301C70B811").IsUnique();
