...
using ApiGerenciamentoSenai.DTOs.UsuarioDto;
...
namespace ApiGerenciamentoSenai.Application.Services
{
    public class UsuarioService
    {
        ...
        {
            Validacoes.ValidarNome(dto.Nome);
            Validacoes.ValidarNif(dto.NIF);
            Validacoes.ValidarCpf(dto.CPF);
            Validacoes.ValidarEmail(dto.Email);
